package com.alangoncalves.workshopmongo.config;
...
import com.alangoncalves.workshopmongo.dto.AuthorDTO;
import com.alangoncalves.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Aproveita", sdf.parse("23/03/2018"), new AuthorDTO(bob));
